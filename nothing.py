...
print("\033[1;92mX=====================================X")
print ("                                                ")
print ("\033[1;96mSCRIPT SPAM SMS                       ")
print ("Like Password:\033[37;1m https://pastebin.com/raw/1an9x>")
print ("                                                ")
print("\033[1;92mX=====================================X")
print("\033[1;96m")
print("")
print("    YouTube :\033[37;1m  Nothing YT")
print("\033[1;96m")
print("กด ctrl z เพื่อหยุด")
print("ห้ามแจก")
print ("")
for i in range(99999):
    pwd = input ("ใส่รหัสผ่าน :\033[37;1m ")
    l=99999
    if(pwd==password):
     print("ACCES GRANTED")
     break
    else:
        print("\033[1;96mรหัสผ่านผิด\033[1;97m",i-l)
os.system("clear")
os.system("figlet S   P   A   M   S   M   S")
print ("\t\033[37;1m")
print("\033[1;92mFacebook\033[37;1m : \033[36;1mNaranan Leejaroen      ")
print ("\033[1;92mYouTube\033[37;1m  : \033[36;1mNothing YT ")
print ("")
print("\033[37;1m                 ห้ามขาย 66 แทน 0")
print ("\033[37;1m               IDline : \033[1;96m ...... ")
print ("              \033[1;96m S  P  A  M  S  M  S\033[1;97m")
print("")
print(" ห้ามขาย ห้ามขาย ห้ามขาย")
session = requests.Session()
print("########################################")
print ("\033[90m>\033[1;97m ตัวอย่าง: \033[1;92m+668293400997")
number = input("\033[90m> \033[1;97mใส่เบอร์เหยื่อย:\033[1;96m+")
delay = input("\033[90m> \033[1;97m delay time: \033[96m")
print("\033[31;1mเกิดไรขึ้นไม่รับผิดชอบ ")
num = int(input("\033[90m> \033[1;97mจำนวน: \033[1;97m"))
print("########################################")
num = int("" + number)
class SMS():
...
time.sleep(1)
print ("")
print ("\033[34;1m[\033[37;1m+\033[34;1m]\033[36;1m กำลังยิง AISPlay.../")
print ("")
print ("")
time.sleep(1)
t = SMS()
def loop(num):
    for i in range(num):
        t.spamais(num)
        print('\033[34;1m[\033[37;1mส่งไปแล้ว\033[34;1m] \033[34;1m[\033[37;1m1\033[34;1m] \033[36;1m '+ number )
